...
let CultivosController = class CultivosController {
    ...
    update(data) {
        const { id } = data, updateCultivoDto = __rest(data, ["id"]);
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'find_all_cultivos' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], CultivosController.prototype, "findAll", null);
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'find_one_cultivo' }),
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'create_cultivo' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'update_cultivo' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'remove_cultivo' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
